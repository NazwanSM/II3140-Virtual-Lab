...
export default function Login() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            setError("Gagal login dengan Google. Pastikan OAuth sudah di-setup.");
            console.error(err);
        }
    };
            ...
            <div className="relative w-full max-w-md bg-white p-8 sm:p-12 rounded-2xl border-2 border-black shadow-[2px_5px_5px_#000000]">
                ...
                <form onSubmit={handleEmailLogin} className="space-y-6">
                    ...
                    <div className="pt-2 text-center">
                        <button 
                            className="btn-image hover:scale-105 transition-transform" 
                            type="submit"
                            disabled={loading}
                        >
                            <span className="sr-only">{loading ? "Loading..." : "Masuk"}</span>
                        </button>
                    </div>
                    ...
                    <div className="text-sm text-center text-gray-600">
                        Belum punya akun?{" "}
                        <a href="#" className="font-bold text-black hover:underline" onClick={() => router.push('/signup')}>
                            Daftar Sekarang
                        </a>
                    </div>
                </form>
